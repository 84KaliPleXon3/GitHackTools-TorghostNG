...
class English:
    ...
    description = """TorghostNG 1.4 - Make all your internet traffic anonymized through Tor proxy
...
class Vietnamese(English):
    ...
    description = """TorghostNG 1.4 - Giúp bạn kết nối Internet ẩn danh qua Tor
